...
<div class="col-lg-10 mx-auto">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <a href="/admin/attendance/riwayat" class="text-decoration-none">
                <div class="card shadow border-left-primary h-100 py-2">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p class="text-muted">Lihat data kehadiran karyawan.</p>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <!-- Card Scan QR -->
        <div class="col-md-6 mb-4">
            <a href="/admin/attendance/qrcode" class="text-decoration-none">
                <div class="card shadow border-left-success h-100 py-2">
                    <div class="card-body">
                        <div class="text-center">
                            <i class="fas fa-qrcode fa-2x text-success mb-2"></i>
                            <h5 class="font-weight-bold text-dark">Generate QR Absen</h5>
